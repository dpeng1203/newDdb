<template>
    <div class="device-qr">
        ...
        <div class="box">
            <div class="border">
                <div class="wrap">
                    <qrcode :url="qrText" :iconurl="imageUrl" :wid="150" :hei="150" :imgwid="25" :imghei="25"></qrcode>
                </div>
            </div>
...
export default {
    ...
    // },
    created() {
        this.qrText = 'http://web2.dodohz.com/ddbxry/index.html#/user/qrRecommend?aCode=' +
            JSON.parse(window.localStorage.user).aCode + '&aType=' + JSON.parse(window.localStorage.user).aType
            // alert(this.qrText)
    }
}
